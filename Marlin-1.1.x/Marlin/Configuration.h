  ...
  */
  ...
  #define STRING_CONFIG_H_AUTHOR "Jonatas Santos" // Who made the changes.
  ...
  */
  #define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 2820, 500 }
  ...
  */
  ...
  #define Z_MAX_POS 170 // Diminuir altura máxima
